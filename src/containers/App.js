  ...
  render() {
    ...
    return (
      <div className="explorer">
        <h1 className="Header-1"><b>Search the U.S.-Swiss Safe Harbor List</b></h1>
        ...
        <p>
          As of October 31, 2016, the Department stopped accepting all U.S.-EU Safe Harbor certifications. The Department will maintain the <a href="https://www.export.gov/safeharbor_eu">U.S.-EU Safe Harbor List</a> of participants.
        </p>
        <p>
